...
if (isset($id)) {
    $db = getDB();
    $stmt = $db->prepare("SELECT Acc.id, account_number, account_type, balance, opened_date, last_updated, user_id, Users.username FROM Account as Acc JOIN Users on Acc.user_id = Users.id where Acc.id = :id");
