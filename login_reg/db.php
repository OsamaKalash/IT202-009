...
function getDB(){
    ...
    if(!isset($db)) {
        try{
            ...
            //it gets the absolute path to this file, then we append the relative url (so up a directory and insid>
            require_once(__DIR__. "/home/ok44/public_html/IT202-009/lib/config.php");//pull in our credentials
